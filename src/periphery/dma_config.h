...
#define DMA_CH_CFG_READ_REQUEST_M               (0xF << DMA_CH_CFG_READ_REQUETS_S)
#define DMA_CH_CFG_READ_REQUEST(v)              (((v) << DMA_CH_CFG_READ_REQUETS_S) & DMA_CH_CFG_READ_REQUETS_M)

#define DMA_CH_CFG_WRITE_REQUEST_S              21    // выбор канала записи
#define DMA_CH_CFG_WRITE_REQUEST_M              (0xF << DMA_CH_CFG_WRITE_REQUETS_S)
#define DMA_CH_CFG_WRITE_REQUEST(v)             (((v) << DMA_CH_CFG_WRITE_REQUETS_S) & DMA_CH_CFG_WRITE_REQUETS_M)
