...
fix32_t fix32_exp(fix32_t inValue) {
	...
	if(inValue >= (int64_t)92288378626) return fix32_maximum;	//fix32_from_dbl(ln(fix32_to_dbl(fix32_maximum))) = fix32_from_dbl(ln(2147483648)) = fix32_from_dbl(21.487562597) = 92288378625
	if(inValue <= (int64_t)-98242467570) return 0;			//fix32_from_dbl(ln(fix32_to_dbl(fix32_epsilon))) = fix32_from_dbl(ln(0.00000000023283064365)) = fix32_from_dbl(-22.1807097779) = -95265423098
